...
RESULTS_DIR="./results/diffmax_cross_backbone_patchtst_etth2"
LOGS_DIR="./logs/diffmax_cross_backbone_patchtst_etth2"
DONE_DIR="./done/diffmax_cross_backbone_patchtst_etth2"
